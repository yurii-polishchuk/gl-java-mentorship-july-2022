...
public class HostControllerFixture {
    ...
    static final String BLANK_DESCRIPTION_MESSAGE = "description: must not be blank";
    ...
    static final ReplaceHostResponse REPLACE_HOST_RESPONSE_VALID = ReplaceHostResponse.builder()
            .title("Apple")
            .description("Apple Inc.")
            .url("https://apple.com/")
            .id(3L)
